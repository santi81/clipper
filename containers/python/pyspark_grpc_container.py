...
class PySparkContainer(grpc_server.ModelContainerBase):
    def __init__(self, path, input_type):
        self.input_type = grpc_server.string_to_input_type(input_type)
...
if __name__ == "__main__":
    ...
    try:
        ...
        rpc_service.start(model, port, model_name, model_version,
                          input_type)
    except ImportError:
